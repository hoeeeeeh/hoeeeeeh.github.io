...
![kubectl_get_nodes]({{ site.url }}{{ site.baseurl }}/assets/images/kubernetes-using-docker/kubectl_get_nodes.png)
...
![expose_result]({{ site.url }}{{ site.baseurl }}/assets/images/kubernetes-using-docker/expose_result.png)
와 같은 결과를 얻을 수 있다.
