...
![kind-cluster-result]({{ site.url }}{{ site.baseurl }}/assets/images/2023-05-04-kind-m1-k8s/kind-cluster-result.png)  

![kind-cluster-docker]({{ site.url }}{{ site.baseurl }}/assets/images/2023-05-04-kind-m1-k8s/kind-cluster-docker.png)  

![kind-cluster]({{ site.url }}{{ site.baseurl }}/assets/images/2023-05-04-kind-m1-k8s/kind-cluster.png)  

위의 사진처럼 도커에 컨테이너가 생기고, 이 컨테이너들을 클러스터로 묶은 것을 알 수 있다.
