...
![kind-cluster-result]({{ site.img }}/2023-05-04-kind-m1-k8s/kind-cluster-result.png)  

![kind-cluster-docker]({{ site.img }}/2023-05-04-kind-m1-k8s/kind-cluster-docker.png)  

![kind-cluster]({{ site.img }}/2023-05-04-kind-m1-k8s/kind-cluster.png)  
